    ...
    public SerialComm(String name, CommPortIdentifier sPI, int baud, JLabel rc, JProgressBar jVoltLvl) {
        ...
        try {
           ...
           // System.out.println("serialPort.getName() = " + serialPort.getName());
            ...
            Logger.getLogger(DimmerServerGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
                ...
                try {
                    while (inputStream.available() > 0) {
                        ...
                        if(cnt == 2)
                        {
                            ...
                            DimmerServerGUI.phase_value=delay;
                            double v =220.0- (delay * 220/DimmerServerGUI.max_phase_value);
                            if(readChars.getText().length()>45)
                                readChars.setText(""); 
                        ...
                        if(readChars.getText().length()>50)
                                readChars.setText(""); 
