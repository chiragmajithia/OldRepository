...
public class Fourier extends Applet {
    ...
    int hpix, vpix, centerx, centery, offsetX, offsetY,in,nf,cnt=0,exprl=0;
    ...
    public void axis(Graphics g) {
        ...
        while (cnt1 <= NoXseg) {
            ...
            print = Math.round(llmt + (Xsegwidth * dx * cnt1));
	...
	for(in=0;in<exprl;in++)
	{
        ...
        s=inp.readLine();
        llmt=Double.parseDouble(s);
        System.out.print("Upper Limit");
        s=inp.readLine();
        ulmt=Double.parseDouble(s);
