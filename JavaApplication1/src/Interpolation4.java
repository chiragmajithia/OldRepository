 ...
 * @author Chirag
 */
public class Interpolation4 extends Applet {
    ...
    public void plot_Interpolation(Graphics g)
    {
        ...
        for(i=0;i<num_input-1;i++)
        {
            ...
            /*if(Math.abs(dm)<=(pi/2))
            {
                ch=0.85+(0.15/pi*2*Math.abs(dm));
            }
            if(Math.abs(dm)>=(pi/2))
            {
                ch=0.98-(0.18/pi*Math.abs(dm));
            }*/
            dm/=div;
            ...
            for(j=0;j<=div;j++)
            {
                ...
                //System.out.println("xu= "+xu+"yu= "+yu+"j= "+j+"m["+i+"]= "+(m[i]*180/pi)+"dm ="+(dm*180/pi)+"mu= "+(Math.atan(mu)*180/pi));
    ...
    public void calSlope()
    {
            ...
            for(i=0;i<num_input;i++)
            {
                    ...
                    System.out.println("Slope "+i+" ="+(m[i]*180/3.1415926535897932384626433832795));
            }
    }
