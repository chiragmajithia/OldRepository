 ...
 */public class Main extends javax.swing.JFrame {
   ...
   // JScrollPane S=new JScrollPane();
    JTextField expr[]=new JTextField[40];
    JTextField llmt[]=new JTextField[40];
    JTextField ulmt[]=new JTextField[40];
    JLabel exprlbl[]=new JLabel[40];
    JLabel llbl[]=new JLabel[40];
    JLabel ulbl[]=new JLabel[40];
	...
	obj.Function[j][obj.in]='=' ;
        ...
        f_out.setExtendedState(JFrame.MAXIMIZED_BOTH);;
        ...
        //f_r.add(T);
        result.add(l1);
        l1.setText("THD :: "+obj.THD+"   Irms :: "+obj.Irms);
        f_r.setAlwaysOnTop(true);
        f_r.setSize(400,350 );
        f_r.setTitle("Frequency Response");
        f_r.setVisible(true);
        S.setVisible(true);
        T.setVisible(true);
        result.setTitle("THD And Irms");
        result.setBounds(450,300,500,200);
    ...
    private void initComponents() {
        ...
        T.setModel(new javax.swing.table.DefaultTableModel(
            new Object [1000][4], new String [] { "Sr.No", "An", "Bn", "Cn" })
            {
    ...
    void construct()
    {
            ...
            ulmt[i-1].addFocusListener(new FocusAdapter()
            {
                public void focusLost(FocusEvent e)
                {
                    ...
                    {
                        ulmt[i-1].removeFocusListener(this);
                        construct();
                    }
                }
            });
 ...
 */
    ...
    Point loc = new Point();
    double maxpos, maxneg, llmt, ulmt, Fx, x, nodx, nody, dx, min, Xp_d, Yp_d, Xp_dx, Yp_dy, Xsegwidth, Ysegwidth, NoXseg, NoYseg,maxCn,Irms,THD;
    int index,hpix, vpix, centerx, centery, offsetX, offsetY,in,nf,cnt=0,exprl=0,expno=0,TD,f,l;
    int length[]=new int[20];
    char Function[][]=new char[20][1000];
    double interval[][]=new double[20][2];
    char expr[]=new char[1000];
    double mul[]=new double[20];
    double powr[]=new double[20];
    double trig[][]=new double[20][3];
  ...
  //              System.out.println("+"+ans+"   c:: "+c);
    ...
    void initVariables()throws IOException
    {
        ...
        hpix=screenSize.width-100;
        vpix=screenSize.height-150;
        nodx=3000;
        NoXseg=5;
        NoYseg=5;
        f=0;
...
void plotSum(Graphics g)
{
    ...
    double pixel_dy,fx;
    int  flag = 0, pX = 0, pY = 0, X = 0, Y = 0,cnt1=0;
    System.out.println("dxplotsum="+dx+"l="+l);
    l=400;
        //dx = (ulmt - llmt) / nodx;
        x = interval[0][0];
        //System.out.println("hpix_dx"+Xp_dx+"pixel_dx"+pixel_dx);
...
void result()
{
    Irms=Math.sqrt(trapezoidSquare()/(2*3.1415926535897932384626433832795));
    System.out.println("Rms value"+Irms);
    double I1=cn[1]/Math.sqrt(2);
    System.out.println("I1 ="+I1);
    THD=Math.sqrt(Math.abs(Math.pow((Irms/I1),2)-1));
